        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .hero {
            ...
            background: linear-gradient(rgba(0,0,0,0.45), rgba(0,0,0,0.65)),
                        url('https://drive.google.com/file/d/1aRkdjF-QrH7RLtBtEQe1NvOYgtFg-XfO/view?usp=sharing') center/cover no-repeat;
            display:flex;
...
<body>
    ...
    <nav id="navbar">
        <div class="logo">
            <img src="https://drive.google.com/file/d/1NCVu-GfKlMzTcgb2Mcmjz_ZUm_WzvZvr/view?usp=sharing" alt="Seasonal Supply Co.">
        </div>
        <div class="nav-links">
            <a href="#home">Home</a>
    ...
    <section id="product" class="product-section">
        <div class="product-image">
            <img src="https://drive.google.com/file/d/18k-067Zrrq_9dSp70vmc9cJ9zDQOSRcs/view?usp=sharing" alt="Glowing Lithophane Ornament on Christmas Tree">
        </div>
        <div class="product-info">
            ...
            <ul class="features">
                ...
                <li>2.5-inch diameter – perfect tree size</li>
            </ul>
    ...
    <section id="about" class="about-section">
        ...
        <div class="about-grid">
            <div class="about-image">
                <img src="https://drive.google.com/file/d/1NCVu-GfKlMzTcgb2Mcmjz_ZUm_WzvZvr/view?usp=sharing" alt="Seasonal Supply Co. Workshop">
            </div>
